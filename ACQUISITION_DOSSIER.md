...
| Reference layer | Forty-two citable, archivable routes | See Reference Footprint |
...
| The internal link graph | Forty-two routes, no orphans, mapped on `/architecture/` |
...
- **Forty-two routes** across eight clusters: Definition & Comparison, Measurement &
