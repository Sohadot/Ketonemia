...
| Reference layer | Forty-one citable, archivable routes | See Reference Footprint |
...
| The internal link graph | Forty-one routes, no orphans, mapped on `/architecture/` |
...
- **Forty-one routes** across eight clusters: Definition & Comparison, Measurement &
