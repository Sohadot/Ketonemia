...
| Reference layer | Thirty-nine citable, archivable routes | See Reference Footprint |
...
| The internal link graph | Thirty-nine routes, no orphans, mapped on `/architecture/` |
...
- **Thirty-nine routes** across eight clusters: Definition & Comparison, Measurement &
