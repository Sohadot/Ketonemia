...
| Reference layer | Thirty-eight citable, archivable routes | See Reference Footprint |
...
| The internal link graph | Thirty-eight routes, no orphans, mapped on `/architecture/` |
...
- **Thirty-eight routes** across eight clusters: Definition & Comparison, Measurement &
