...
| Reference layer | Forty-three citable, archivable routes | See Reference Footprint |
...
| The internal link graph | Forty-three routes, no orphans, mapped on `/architecture/` |
...
- **Forty-three routes** across eight clusters: Definition & Comparison, Measurement &
