...
| Reference layer | Thirty-seven citable, archivable routes | See Reference Footprint |
...
| The internal link graph | Thirty-seven routes, no orphans, mapped on `/architecture/` |
...
- **Thirty-seven routes** across eight clusters: Definition & Comparison, Measurement &
