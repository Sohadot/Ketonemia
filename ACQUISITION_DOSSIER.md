...
| Reference layer | Forty citable, archivable routes | See Reference Footprint |
...
| The internal link graph | Forty routes, no orphans, mapped on `/architecture/` |
...
- **Forty routes** across eight clusters: Definition & Comparison, Measurement &
